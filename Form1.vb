...
#End Region
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'textbox movment
        Label1.Location = New Point(1500, 10)
        TextBox1.Location = New Point(1500, 40)
        TextBox2.Location = New Point(1530, 40)
        Button2.Location = New Point(1500, 70)
        Button3.Location = New Point(1500, 100)
        'textbox hide
        Label1.Hide()
        TextBox1.Hide()
        TextBox2.Hide()
...
#Region "擲骰子+人物移動"
    ...
    Private Sub DiceButton_Click(sender As Object, e As EventArgs) Handles Dicebutton.Click '擲骰子
        ...
        'change the label to current player

        CurrentPlayer += 1
        If CurrentPlayer Mod 4 = 0 Then
            TextBox1.Text = "a"
        ElseIf CurrentPlayer Mod 4 = 1 Then
            TextBox1.Text = "b"
        ElseIf CurrentPlayer Mod 4 = 2 Then
            TextBox1.Text = "c"
        ElseIf CurrentPlayer Mod 4 = 3 Then
            TextBox1.Text = "d"
        End If
